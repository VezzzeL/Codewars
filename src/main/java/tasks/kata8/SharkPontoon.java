...
// as you do the mental calculations in the water you either freeze when you realise you are dead, or swim when you
// realise you can make it!
...
public class SharkPontoon {
    public static String shark(int pontoonDistance, int sharkDistance,
        ...
        return (pontoonDistance / (double) youSpeed) <= (sharkDistance / (dolphin ? sharkSpeed / 2.0 : sharkSpeed)) ?
                "Alive!" : "Shark Bait!";
