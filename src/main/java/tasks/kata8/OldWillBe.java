...
// His parents can't keep up calculating this so they've begged you to help them out by writing a programme that
...
// to. As Philip is getting more curious every day he may soon want to know how many years it was until he would be
// born, so your function needs to work with both dates in the future and in the past.
...
public class OldWillBe {
    public static String CalculateAge(int birth, int yearTo) {
        int age = yearTo - birth;
        if (age == -1) {
            return String.format("You will be born in 1 year.");
        } else if (age == 0) {
            return "You were born this very year!";
        } else if (age == 1) {
            return String.format("You are 1 year old.");
        } else if (age < 0) {
            return String.format("You will be born in %d years.", -age);
        } else {
